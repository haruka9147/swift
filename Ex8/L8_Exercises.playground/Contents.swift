...
var t1 = Teenager(age: 16, responsible:true, patience: Level.medium)
t1.playCandyland(2)
//: __Problem 2__
//:
...
class Animal:Adorable {
    ...
    func curlIntoSmallBall() {
        print("call curlIntoSmallBall()")
    }
}
var pic = UIImage(named: "frolick.jpg")

var a1 = Animal(species: "???", numberOfLegs: 4)
a1.frolick()
a1.curlIntoSmallBall()
//: __Problem 3__
//:
...
extension UIColor
{
    ...
    func pistachio() -> UIColor {
        let r   = CGFloat(Double(147) / 255.0)
        let g = CGFloat(Double(197) / 255.0)
        let b  = CGFloat(Double(114) / 255.0)
