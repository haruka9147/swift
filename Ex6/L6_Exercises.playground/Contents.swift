...
var a1 = Animal(tail: Tail(lengthInCm: 2.0))
print(a1.tail.lengthInCm)
//: __Problem 2__
//:
...
var p1 = Peach(variety: "???", softness: 5)
print(p1.ripen())
//: __Problem 3__
//:
//: __3a.__
...
class FluffyDog {
    ...
    var cuddlability: Int {
        let cudd = (self.fluffiness, self.droolFactor)
        switch cudd {
        case (let fluffiness, let droolFactor) where fluffiness > 0 && droolFactor > 0:
            return 5
        default:
            return 0
        }
...
var f1 = FluffyDog(name: "???", fluffiness: 3, droolFactor: 3)
print(f1.chase("???"))
//: __Problem 4__
//:
//: __4a.__
...
var d1 = ChattyDog(name: "???", breed: "???", size: Size.large)
print(d1.bark())
//: __4c.__
